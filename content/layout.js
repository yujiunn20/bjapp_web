  ...
  const sections = {
    ...
    pc: {
      ...
      items: [
        ...
        { title: "模擬範例", path: "content/pc/sim-examples.html" },
      ...
      sections: {
        ...
        pc: {
          ...
          items: [
            ...
            { title: "Sim Examples", path: "content/pc/sim-examples.html" },
      ...
      sections: {
        ...
        pc: {
          ...
          items: [
            ...
            { title: "シミュ例", path: "content/pc/sim-examples.html" },
  ...
  function pageTitle(path, fallbackTitle) {
    const titles = {
      "zh-Hant": {
        ...
        "content/pc/sim-examples.html": "用模擬驗證算牌策略｜Blackjack 算牌訓練器 PC 版",
      ...
      en: {
        ...
        "content/pc/sim-examples.html": "Simulation Validation Examples | Blackjack Card Counting Trainer PC App",
      ...
      ja: {
        ...
        "content/pc/sim-examples.html": "シミュレーション検証例 | ブラックジャック カウントトレーナー PC アプリ",
  ...
  function pageDescription(path, fallbackTitle) {
    const descriptions = {
      "zh-Hant": {
        ...
        "content/pc/sim-examples.html": "PC 版模擬驗證範例，說明如何透過 95% 信賴區間與 Session 統計，確認算牌策略與 Bet Ramp 在統計上具有優勢，並輔助制定停損停利設定。",
      ...
      en: {
        ...
        "content/pc/sim-examples.html": "PC app simulation validation examples showing how 95% confidence intervals and session statistics confirm that a card counting strategy and Bet Ramp have a statistically significant edge.",
      ...
      ja: {
        ...
        "content/pc/sim-examples.html": "PC アプリのシミュレーション検証例。95% 信頼区間と Session 統計を使って、算牌戦略と Bet Ramp が統計的に優位であることを確認し、損切り・利確設定の検討を支援します。",
